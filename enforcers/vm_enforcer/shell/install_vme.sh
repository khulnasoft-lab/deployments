...
is_it_rhel() {
  ...
  if [ $? -eq 0 ]; then
    ...
    curl -s -o khulnasoftvme.te https://raw.githubusercontent.com/khulnasoft-lab/deployments/2022.4/enforcers/vm_enforcer/rpm/selinux/khulnasoftvme/khulnasoftvme.te
    curl -s -L -o khulnasoftvme.pp https://github.com/khulnasoft-lab/deployments/raw/2022.4/enforcers/vm_enforcer/rpm/selinux/khulnasoftvme/khulnasoftvme.pp
...
is_it_fedora() {
  ...
  if [ $? -eq 0 ]; then
    ...
    echo "Info: Downloading SELinux policy module"
    curl -s -o fcos_khulnasoftvme.te https://raw.githubusercontent.com/khulnasoft-lab/deployments/2022.4/enforcers/vm_enforcer/rpm/selinux/khulnasoftvme/fcos_khulnasoftvme.te
    curl -s -L -o fcos_khulnasoftvme.pp https://github.com/khulnasoft-lab/deployments/raw/2022.4/enforcers/vm_enforcer/rpm/selinux/khulnasoftvme/fcos_khulnasoftvme.pp
...
get_templates_online() {
  ...
  curl -s -o ${ENFORCER_SERVICE_TEMPLATE_FILE_NAME} https://raw.githubusercontent.com/khulnasoft-lab/deployments/2022.4/enforcers/vm_enforcer/templates/khulnasoft-enforcer.template.service
  curl -s -o ${ENFORCER_SERVICE_TEMPLATE_FILE_NAME_OLD} https://raw.githubusercontent.com/khulnasoft-lab/deployments/2022.4/enforcers/vm_enforcer/templates/khulnasoft-enforcer.template.old.service
  curl -s -o ${RUN_SCRIPT_TEMPLATE_FILE_NAME} https://raw.githubusercontent.com/khulnasoft-lab/deployments/2022.4/enforcers/vm_enforcer/templates/run.template.sh
  curl -s -o ${ENFORCER_RUNC_CONFIG_TEMPLATE} https://raw.githubusercontent.com/khulnasoft-lab/deployments/2022.4/enforcers/vm_enforcer/templates/khulnasoft-enforcer-runc-config.json
